...
use crate::{
    chain::{ArbitrumChainInfo, ArbitrumChainInfoTr},
    local_context::{ArbitrumLocalContext, ArbitrumLocalContextTr},
};

/// Type alias for the default context type of the ArbitrumEvm.
pub type ArbitrumContext<DB> =
    Context<BlockEnv, TxEnv, CfgEnv, DB, Journal<DB>, ArbitrumChainInfo, ArbitrumLocalContext>;
